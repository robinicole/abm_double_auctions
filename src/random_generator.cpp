...
uint32_t RandomGenerator::int32() {
...
MockRandomGenerator::MockRandomGenerator(double fixed_uniform, double fixed_gaussian)
...
void MockRandomGenerator::setUniformSequence(const std::vector<double>& values) {
